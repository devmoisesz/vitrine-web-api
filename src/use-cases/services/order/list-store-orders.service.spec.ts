...
import { ListStoreOrdersService } from './list-store-orders.service';

describe('List Store Orders Service', () => {
  ...
  let sut: ListStoreOrdersService;
  ...
  beforeEach(() => {
    ...
    sut = new ListStoreOrdersService(ordersRepository, storesRepository);
  });

  it('must list the store orders', async () => {
